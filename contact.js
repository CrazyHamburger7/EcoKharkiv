...
document.querySelectorAll(".nav-links a")[0].innerHTML = "Home";
document.querySelectorAll(".nav-links a")[1].innerHTML = "Pages";
document.querySelectorAll(".nav-links a")[2].innerHTML = "Ecological problems of Kharkiv";
...
document.querySelectorAll(".nav-links a")[9].innerHTML = "Eco-volunteering";
      ...
      document.querySelectorAll(".nav-links a")[0].innerHTML = "Головна";
